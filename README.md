...
aspen:
  ...
  script:
    ...
    - npx @securityjourney/aspen-connector@0.1.1
  variables:
...
jobs:
  aspen:
    ...
    steps:
      ...
      - uses: SecurityJourney/aspen-connector@v0.1.1
        with:
